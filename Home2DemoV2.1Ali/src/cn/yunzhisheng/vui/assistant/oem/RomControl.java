...
public class RomControl {
	...
	public static final String ROM_INCREASE_LIGHT = "ROM_INCREASE_LIGHT";
	public static final String ROM_DECREASE_LIGHT = "ROM_DECREASE_LIGHT";
	public static final String ROM_LIGHT_MAX = "ROM_LIGHT_MAX";
	public static final String ROM_LIGHT_MIN = "ROM_LIGHT_MIN";
	
	
	public static final String ROM_INCREASE_CHANNEL = "ROM_INCREASE_CHANNEL";
	public static final String ROM_DECREASE_CHANNEL = "ROM_DECREASE_CHANNEL";
	...
	//private static final String INTENT_VOICE_SEARCH = "com.iqiyi.intent.voice.search";
	private static final String INTENT_VOICE_VOLUME_INCREASE = "com.iqiyi.intent.voice.volume.increase";
	private static final String INTENT_VOICE_VOLUME_DECREASE = "com.iqiyi.intent.voice.volume.decrease";
	private static final String INTENT_VOICE_CHANNEL_NEXT = "com.iqiyi.intent.voice.channel.next";
	private static final String INTENT_VOICE_CHANNEL_LAST = "com.iqiyi.intent.voice.channel.last";
	private static final String INTENT_VOICE_APP_EXIT = "com.iqiyi.intent.voice.app.exit";
	...
	public static void enterControl(Context context, String type, Object... params) {
		...
		LogUtil.d(TAG, "TYPE:" + type + logParams);
		...
		if (ROM_APP_LAUNCH.equals(type)) {
			...
			enterGlobalIntent(context,INTENT_VOICE_VOLUME_DECREASE,null);
		} else if (ROM_INCREASE_VOLUMNE.equals(type)) {
			//RomSystemSetting.RaiseOrLowerVolume(context, true, (Integer) params[0]);
			enterGlobalIntent(context,INTENT_VOICE_VOLUME_INCREASE,null);
			...
			enterGlobalIntent(context,INTENT_VOICE_APP_EXIT,(String) params[0]);
		} else if (ROM_DECREASE_LIGHT.equals(type)) {
			RomSystemSetting.increaseAct(context, false, (Integer) params[0]);
		} else if (ROM_INCREASE_LIGHT.equals(type)) {
			RomSystemSetting.increaseAct(context, true, (Integer) params[0]);
		} else if (ROM_LIGHT_MAX.equals(type)) {
			RomSystemSetting.setMaxVolume(context);
		} else if (ROM_LIGHT_MIN.equals(type)) {
			RomSystemSetting.setMinVolume(context);
		} else if (ROM_DECREASE_CHANNEL.equals(type)) {
			enterGlobalIntent(context,INTENT_VOICE_CHANNEL_LAST,null);
		} else if (ROM_INCREASE_CHANNEL.equals(type)) {
			enterGlobalIntent(context,INTENT_VOICE_CHANNEL_NEXT,null);
		} 
	}
	
	public static void enterGlobalIntent(Context context,String action, String name) {
		LogUtil.d(TAG, "enterGlobalIntent action : " + action + ";name :" + name);

...
import cn.yunzhisheng.vui.assistant.database.SqliteWrapper;
...
public final class Telephony {
	...
	public static final class Sms implements BaseColumns, TextBasedSmsColumns {
		...
		public static final class Draft implements BaseColumns, TextBasedSmsColumns {
			 ...
			 */
			public static boolean saveMessage(ContentResolver resolver, Uri uri, String body) {
				ContentValues values = new ContentValues(2);
				values.put(BODY, body);
	...
	public static final class Mms implements BaseMmsColumns {
		private static final Pattern EMAIL_ADDRESS_PATTERN = Pattern.compile("[a-zA-Z0-9\\+\\.\\_\\%\\-]{1,256}\\@[a-zA-Z0-9][a-zA-Z0-9\\-]{0,64}"
		...
		public static final class ScrapSpace {
			...
			// "/sdcard/mms/scrapSpace/.temp.jpg";
		}
	...
	public static final class Intents {
		 ...
		 * Activities or services that use these strings should update their
		 * display. The intent will have the following extra values:</p>
		 * <ul>
		 * <li><em>showPlmn</em> - Boolean that indicates whether the PLMN
		 * should be shown.</li>
		 * <li><em>plmn</em> - The operator name of the registered network, as a
		 * string.</li>
		 * <li><em>showSpn</em> - Boolean that indicates whether the SPN should
		 * be shown.</li>
		 * <li><em>spn</em> - The service provider name, as a string.</li>
		 * </ul>
		 * Note that <em>showPlmn</em> may indicate that <em>plmn</em> should be
		 * displayed, even though the value for <em>plmn</em> is null. This can
		 * happen, for example, if the phone has not registered to a network
		 * yet. In this case the receiver may substitute an appropriate
		 * placeholder string (eg, "No service").
		 * 
		 * It is recommended to display <em>plmn</em> before / above
		 * <em>spn</em> if both are displayed.
		 * 
		 * <p>
